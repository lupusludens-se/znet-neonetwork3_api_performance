...
@Component({
  selector: 'neo-edit-project-onsilte-solar',
  templateUrl: 'edit-project-onsilte-solar.component.html',
  styleUrls: ['../../edit-project.component.scss'],
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class EditProjectOnsilteSolarComponent implements OnInit {
  ...
  ngOnInit(): void {
    const projectDetails: ProjectOnsiteSolarDetailsInterface = this.project

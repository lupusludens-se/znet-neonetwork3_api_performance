...
@Component({
  selector: 'neo-efficiency-audit',
  templateUrl: './efficiency-audit.component.html',
  styleUrls: ['../../add-project.component.scss']
})
export class EfficiencyAuditComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.addProjectService.currentFlowData?.projectDetails) {
      const formVal: ProjectEfficiencyAuditsDetailsInterface = this.addProjectService.currentFlowData

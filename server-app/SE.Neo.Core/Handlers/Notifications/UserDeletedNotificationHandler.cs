...
{
    internal class UserDeletedNotificationHandler : BaseNotificationHandler
    {
        public UserDeletedNotificationHandler(ApplicationContext context, IMapper mapper, NotificationType type)
        ...
        {
            if (details is UserDeletedNotificationDetails)
            {

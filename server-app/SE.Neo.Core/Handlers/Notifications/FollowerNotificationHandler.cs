...
{
    internal class FollowerNotificationHandler : BaseNotificationHandler
    {
        public FollowerNotificationHandler(ApplicationContext context, IMapper mapper, NotificationType type)
        ...
        {
            if (details is FollowerNotificationDetails)
            {
                ...
                return await InsertOrUpdateNotification(new NotificationDTO(userId, _type, details),
                    (currentDetails, _) =>
                    {
                        return new GroupFollowersNotificationDetails
                        {
                            FollowerUserId = (currentDetails as BaseFollowerNotificationDetails)!.FollowerUserId,
                            FollowerName = (currentDetails as BaseFollowerNotificationDetails)!.FollowerName,

...
VALUES 
    ...
    (5, 'DER Map', '', 4, GETDATE(), GETDATE(), NULL, 8),
    (6, 'What are Scope 1 Emissions?', '', 2, GETDATE(), GETDATE(), 571, NULL),
    (7, 'Energy Attribute Certificate (EAC) - Global Indicative Pricing Dashboard', '', 4, GETDATE(), GETDATE(), NULL, 1),
    ...
    (22, 'Onsite solar request tool', '', 5, GETDATE(), GETDATE(), NULL, 4),
    (23, 'PPA Tracker', '', 4, GETDATE(), GETDATE(), NULL, 2),
    (24, 'Recovering Heat from Exhaust Air', '', 1, GETDATE(), GETDATE(), 534, NULL),
    (25, 'What is a Physical PPA?', '', 1, GETDATE(), GETDATE(), 801, NULL),
    (26, 'Strategy Calculator', '', 4, GETDATE(), GETDATE(), NULL, 16),

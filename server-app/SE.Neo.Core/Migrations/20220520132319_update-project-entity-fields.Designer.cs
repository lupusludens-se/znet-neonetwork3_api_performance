...
namespace SE.Neo.Core.Migrations
{
    ...
    [Migration("20220520132319_update-project-entity-fields")]
    partial class updateprojectentityfields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.EventInvitedCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("Event_Invited_Company_Id");
                    ...
                    b.ToTable("Event_Invited_Company");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectBatteryStorageDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectFuelCellsDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ValueProvided", b =>
                {
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("Project_Value_Provided_Name");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            Name = "RenewableAttributes"
                        },
                        new
                        {
                            Id = 7,
                            Name = "MitigatingClimateChange"
                        },
                        new
                        {
                            Id = 8,
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.EventInvitedCompany", b =>
                {
                    ...
                    b.HasOne("SE.Neo.Core.Entities.Event", "Event")
                        .WithMany("EventInvitedCompanies")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Event", b =>
                {
                    ...
                    b.Navigation("EventInvitedCompanies");

...
{
    public partial class UpdateAzureSearchViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                "CAST(CASE WHEN dbo.Discussion.Discussion_Type = 1 THEN 1 ELSE 0 END AS bit) as Is_Private," +
                ...
                "(SELECT CONVERT(varchar, dbo.Discussion_User.User_Id) as AllowedUserId " +
                ...
                "1 as Entity_Type " +
                "FROM dbo.Discussion " +
                "WHERE (dbo.Discussion.Discussion_Type = 1 OR dbo.Discussion.Discussion_Type = 2)");
            ...
            migrationBuilder.Sql(
               ...
               "CAST(CASE WHEN Status_Id = 1 THEN 1 ELSE 0 END AS bit) as Is_Deleted, Description," +
               "(SELECT dbo.CMS_Category.CMS_Category_Id as CategoryId, dbo.CMS_Category.Category_Name as Name " +
               ...
               "FOR JSON AUTO) as Categories," +
               "(SELECT CONVERT(varchar, dbo.Event_Invited_Category.Category_Id) as AllowedCategoryId " +
            ...
            migrationBuilder.Sql(
               ...
               "(SELECT CONVERT(varchar, dbo.Tool_Role.Role_Id) as AllowedRoleId " +
               "FROM dbo.Tool_Role " +
               "WHERE dbo.Tool_Role.Tool_Id = dbo.Tool.Tool_Id " +
               "FOR JSON AUTO) as Allowed_Roles," +
               "(SELECT CONVERT(varchar, dbo.Tool_Company.Company_Id) as AllowedCompanyId " +

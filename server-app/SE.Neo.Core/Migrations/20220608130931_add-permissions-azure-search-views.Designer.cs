...
namespace SE.Neo.Core.Migrations
{
    ...
    [Migration("20220608130931_add-permissions-azure-search-views")]
    partial class addpermissionsazuresearchviews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ActivityLocation", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 21,
                            Name = "Your discission filter apply"
                        },
                        new
                        {
                            Id = 22,
                        ...
                        {
                            Id = 23,
                            Name = "For you filter apply"
                        },
                        new
                        {
                            Id = 24,
                            Name = "Saved filter apply"
                        },
                        new
                        {
                            Id = 25,
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Name = "Dashboard Q3 Pricing Report"
                        },
                        new
                        {
                            Id = 5,
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectCarbonOffsetsDetailsTermLength", b =>
                {
                    ...
                    b.HasIndex("ProjectCarbonOffsetsDetailsId");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectEACDetailsTermLength", b =>
                {
                    ...
                    b.HasIndex("ProjectEACDetailsId");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectEmergingTechnologyDetails", b =>
                {
                    ...
                    b.Property<int?>("MinimumAnnualKWh")
                        .HasColumnType("int")
                        .HasColumnName("Minimum_Annual_KWh");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectEVChargingDetails", b =>
                {
                    ...
                    b.Property<int?>("MinimumParkingSpace")
                        .HasColumnType("int")
                        .HasColumnName("Minimum_Parking_Space");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectOffsitePowerPurchaseAgreementDetails", b =>
                {
                    ...
                    b.Property<int?>("ContractPricePerMWh")
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CustomEAC")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Custom_EAC");

                    b.Property<string>("CustomISORTO")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Custom_ISORTO");

                    b.Property<string>("CustomSettlementHubOrLoadZone")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Custom_Settlement_Hub_Or_Load_Zone");
                    ...
                    b.Property<string>("ProjectMWCurrentlyAvailable")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectOffsitePPADetailsValueProvided", b =>
                {
                    ...
                    b.HasIndex("ProjectOffsitePowerPurchaseAgreementDetailsId");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ProjectDetails.ProjectRenewableRetailDetailsPurchaseOption", b =>
                {
                    ...
                    b.HasIndex("ProjectRenewableRetailDetailsId");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.ValueProvided", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 8,
                            Name = "Visible comittment to climate action"
                        },
                        new
                        {
                            Id = 9,

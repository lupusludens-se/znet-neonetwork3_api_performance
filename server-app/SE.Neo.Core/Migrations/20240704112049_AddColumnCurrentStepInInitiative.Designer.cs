...
namespace SE.Neo.Core.Migrations
{
    ...
    [Migration("20240704112049_AddColumnCurrentStepInInitiative")]
    partial class AddColumnCurrentStepInInitiative
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.InitiativeDiscussion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.InitiativeProgressDetails", b =>
                {
                    ...
                    b.Property<int>("ProjectSubStepId")
                        .HasColumnType("int")
                        .HasColumnName("Initiative_Project_Sub_Step_Id");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.InitiativeProjectSubStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Initiative_Project_Sub_Step");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.RegionScale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("Region_Scale_Initiative_Id");
                    ...
                    b.Property<int>("InitiativeScaleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InitiativeScaleId");

                    b.HasIndex("RegionId")
                        .IsUnique();

                    b.ToTable("Region_Scale_Initiative");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Initiative", b =>
                {
                    ...
                    b.HasOne("SE.Neo.Core.Entities.InitiativeStep", "CurrentStep")
                        .WithMany()
                    ...
                    b.HasOne("SE.Neo.Core.Entities.InitiativeScale", "ScaleId")
                        .WithMany()
                        .HasForeignKey("ScaleIdId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SE.Neo.Core.Entities.InitiativeStatus", "StatusId")
                        .WithMany()
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.InitiativeProgressDetails", b =>
                {
                    ...
                    b.HasOne("SE.Neo.Core.Entities.InitiativeProjectSubStep", "ProjectSubStep")
                        .WithMany()
                        .HasForeignKey("ProjectSubStepId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Initiative");

                    b.Navigation("ProjectSubStep");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.InitiativeProjectSubStep", b =>
                {
                    ...
                    b.HasOne("SE.Neo.Core.Entities.InitiativeSubStep", "SubStep")
                        .WithMany()
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.RegionScale", b =>
                {
                    b.HasOne("SE.Neo.Core.Entities.InitiativeScale", "InitiativeScale")
                        .WithMany()
                        .HasForeignKey("InitiativeScaleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

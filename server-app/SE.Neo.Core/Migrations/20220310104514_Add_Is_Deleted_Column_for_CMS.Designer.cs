...
namespace SE.Neo.Core.Migrations
{
    ...
    [Migration("20220310104514_Add_Is_Deleted_Column_for_CMS")]
    partial class Add_Is_Deleted_Column_for_CMS
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("UserBccId")
                        .HasColumnType("int")
                        .HasColumnName("User_Bcc_Id");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.UserPlatformNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("User_Platform_Notification_Id");
                    ...
                    b.Property<int>("PlatformNotificationType")
                        .HasColumnType("int")
                        .HasColumnName("Platform_Notification_Type");
                    ...
                    b.ToTable("User_Platform_Notification");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Conversation", b =>
                {
                    b.HasOne("SE.Neo.Core.Entities.UserProfile", "UserBcc")
                        .WithMany("BccConversations")
                        .HasForeignKey("UserBccId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SE.Neo.Core.Entities.UserProfile", "UserFrom")
                        .WithMany("OwnerConversations")
                        .HasForeignKey("UserFromId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SE.Neo.Core.Entities.UserProfile", "UserTo")
                        .WithMany("ParticipantConversations")
                        .HasForeignKey("UserToId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("UserBcc");
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Message", b =>
                {
                    b.HasOne("SE.Neo.Core.Entities.Conversation", "Conversation")
                        .WithMany("Messages")

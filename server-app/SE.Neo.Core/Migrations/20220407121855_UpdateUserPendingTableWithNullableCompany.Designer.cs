...
namespace SE.Neo.Core.Migrations
{
    ...
    [Migration("20220407121855_UpdateUserPendingTableWithNullableCompany")]
    partial class UpdateUserPendingTableWithNullableCompany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.CompanySolutionCapability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("Company_Solution_Capability_Id");
                    ...
                    b.Property<int>("SolutionCapabilityId")
                        .HasColumnType("int")
                        .HasColumnName("Solution_Capability_Id");
                    ...
                    b.HasIndex("SolutionCapabilityId");

                    b.ToTable("Company_Solution_Capability");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.SolutionCapability", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("Solution_Capability_Id");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("Solution_Capability_Name");
                    ...
                    b.ToTable("Solution_Capability");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Aggregated PPAs"
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 6,
                            Name = "Efficiency Audits & Consulting"
                        },
                        new
                        {
                            Id = 7,
                            Name = "Efficiency Equipment Measures"
                        },
                        new
                        {
                            Id = 8,
                            Name = "EV Charging & Fleet Electrification"
                        },
                        new
                        {
                            Id = 9,
                        ...
                        {
                            Id = 10,
                            Name = "Offsite Power Purchase Agreement"
                        },
                        new
                        {
                            Id = 11,
                            Name = "Onsite Emerging Technologies"
                        },
                        new
                        {
                            Id = 12,
                            Name = "Renewable Retail Electricity"
                        },
                        new
                        {
                            Id = 13,
                            Name = "Utility Green Tariff"
                        },
                        new
                        {
                            Id = 14,
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.CompanySolutionCapability", b =>
                {
                    b.HasOne("SE.Neo.Core.Entities.Company", "Company")
                        .WithMany("SolutionCapabilities")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SE.Neo.Core.Entities.SolutionCapability", "SolutionCapability")
                        .WithMany()
                        .HasForeignKey("SolutionCapabilityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Company");

                    b.Navigation("SolutionCapability");
                });
            ...
            modelBuilder.Entity("SE.Neo.Core.Entities.Company", b =>
                {
                    ...
                    b.Navigation("SolutionCapabilities");

...
export class EVChargingAndFleetElectrificationPage extends BasePage {
  ...
  async createProject(projectData, role) {
    ...
    // Fill the field Minimum Charging Stations Required Required
    await this.newProjectDetails.enterMinimumChargingStationsRequired(projectData.minimumChargingStationsRequired);

...
export class RenewableRetailElectricityPage extends BasePage {
  ...
  async createProject(projectData, role) {
    ...
    //Fill in Purchase Options - Additional Details (optional)
    await this.newProjectDetails.selectPurchaseOptionsAdditionalDetails(projectData.purchaseOptionsAdditionalDetails);
